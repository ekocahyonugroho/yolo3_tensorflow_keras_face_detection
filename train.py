...
def _main():
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='model_data/h5_model/darknet53.h5') # make sure you know what you freeze
            #freeze_body=2, weights_path='logs/wider/ep252-loss31.486-val_loss32.502.h5')
